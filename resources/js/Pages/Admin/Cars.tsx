...
export default function AdminCars({ auth }: PageProps) {
    ...
    <AppLayout>
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Manage Cars</h1>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 bg-white shadow rounded-lg overflow-hidden">
              <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                <h2 className="text-xl font-medium text-gray-900">Car Listings</h2>
                <Link href="/admin/cars/create" className="btn btn-primary btn-sm">
              ...
              <div className="p-6">
                  ...
                  <div className="flex-1">
                    <div className="form-control">
                      <div className="input-group">
                        <input type="text" placeholder="Search cars..." className="input input-bordered w-full" />
                ...
                <div className="bg-blue-50 p-4 rounded-lg mt-8">
                  <h3 className="text-lg font-medium text-blue-800 mb-2">Car Management Guidelines</h3>
                  <ul className="list-disc pl-5 text-blue-700 space-y-2">
                    <li>Use the search bar to find specific cars by make, model, or description</li>
                    <li>Filter cars by status or price range to narrow down results</li>
                    <li>Click on a car's name to view its complete details</li>
                    <li>Use the edit button to update car information and prices</li>
                    <li>Move sold cars to "Sold" status instead of deleting them</li>
                  </ul>
                </div>
              </div>
            </div>
